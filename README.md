# Commodore Component: capi-core

This is a [Commodore][commodore] Component for capi-core.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/capi-core).
